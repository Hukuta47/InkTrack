...
namespace InkTrack.Helpers
{
    public class WordHelper
    {
        ...
        public WordHelper(string filePath)
        {
            ...
            {
                throw new FileNotFoundException($"Файл \"{Directory.GetCurrentDirectory()}\\{filePath}\" не найден в директории программы, переустановите программу для восстановления.");
            }
        }
